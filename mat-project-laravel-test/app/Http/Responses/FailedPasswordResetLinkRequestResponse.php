...
use App\Dtos\Defs\Endpoints\ForgotPassword\Errors\ForgotPasswordErrorDetails;
use App\Dtos\Defs\Endpoints\ForgotPassword\Errors\ForgotPasswordErrorDetailsErrorData;
    ...
    public function toResponse($request)
    {
        ...
        return (new ApplicationException(
            ...
            ApplicationErrorInformation::create()
                ...
                ->setDetails(
                    ForgotPasswordErrorDetails::create()
                        ->setErrorData(
                            ForgotPasswordErrorDetailsErrorData::create()
                                ->setEmail(
                                    FieldError::create()
                                        ->setMessage($error)
                                )
