...
namespace App\Types\XML {
    ...
    class XMLValidParserPosition implements GetXMLParserPositionInterface
    {
        private int $line;
        private int $column;
        ...
        public function setPosFromProvider(GetXMLParserPositionInterface $posProvider): void
        {
            $posProvider->getPos(
                column: $column,
                line: $line,
